...
| `b5q-F731BXXS7GZF1` | Galaxy Z Flip5 `SM-F731B` | `5.15.189` | Hardware verified through root, KernelSU late-load with UID-2000 shell access, and trusted Manager connection; app needs a shell context for the verified tracefs route |
